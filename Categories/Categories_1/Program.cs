...
namespace Categories_1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            manager.Id = 1;
            manager.FullName = "Кулешова Кира Александровна";
            manager.Email = "kuleshovya@gmail.com";
            manager.MonthlySalary = 50000;

            // Создаем сотрудника с почасовой оплатой
            HourlySalaryEmployee developer = new HourlySalaryEmployee();
            developer.Id = 2;
            developer.FullName = "Берёзкин Егор Витальевич";
            developer.Email = "berezkin@gmail.com";
            ...
            freelancer.Id = 3;
            freelancer.FullName = "Будина Ирина Сергеевна";
            freelancer.Email = "Budina@gmail.com";
            freelancer.ProjectPayment = 50000;
